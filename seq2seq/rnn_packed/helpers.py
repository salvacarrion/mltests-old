...
def fit(model, train_iter, dev_iter, epochs, optimizer, criterion, checkpoint_path, clip=1.0,
        tr_writer=None, val_writer=None, tb_batch_rate=100, tf_ratio=0.5):
    # Default values
    ...
    for epoch in range(epochs):
        ...
        train_loss = train(model, train_iter, optimizer, criterion, clip,
                           n_iter=n_iter, tb_writer=tr_writer, tb_batch_rate=tb_batch_rate, tf_ratio=tf_ratio)

        # Evaluate model
        valid_loss = evaluate(model, dev_iter, criterion,
                              n_iter=n_iter, tb_writer=val_writer, tb_batch_rate=tb_batch_rate, tf_ratio=0.0)
...
def train(model, train_iter, optimizer, criterion, clip, n_iter=None, tb_writer=None, tb_batch_rate=None, tf_ratio=0.5):
    model.train()
    epoch_loss = 0
...
def evaluate(model, test_iter, criterion, n_iter=None, tb_writer=None, tb_batch_rate=None, tf_ratio=0.0):
    model.eval()
    epoch_loss = 0
